...
echo " - Profile (port 80):    curl http://localhost/profile_sciel.html"
echo " - Info (port 8100):     curl http://localhost:8100/"
# ----------------------------------------------------------------------
# nano /root/script_nginx_gustave.sh
# chmod +x /root/script_nginx_gustave.sh
# ls -l /root/script_nginx_gustave.sh
# ./root/script_nginx_gustave.sh
